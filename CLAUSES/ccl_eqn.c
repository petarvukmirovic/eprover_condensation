...
/*-----------------------------------------------------------------------
//
// Function: EqnUnifySides()
//
//   Test wether sides of two equations are unifiable. If yes, return true
//   and extend subst to give the substitution, otherwise just return
//   true and let subst unmodifies.
//
// Global Variables: -
//
// Side Effects    : - 
...
bool  EqnUnifySides(Eqn_p eq, Subst_p subst)
{
   return SubstComputeMgu(eq->lterm, eq->rterm, subst);
}
